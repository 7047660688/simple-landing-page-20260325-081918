...
simple landing page for coffee shop
...
> to open Find & Replace across all files. Search for `Coffee Haven` and replace it with your brand name everywhere at once.
...
|----------------|-------------|------------------------------|
| Company name (`Coffee Haven`) | All `.html` files | Use Find & Replace to update it everywhere |
